...
helm install k8s-eni-tagger \
  https://github.com/prabhu-mannu/k8s-eni-tagger/releases/download/v0.1.4/k8s-eni-tagger-0.1.4.tgz \
  --namespace kube-system \
  --create-namespace
```
...
- **Chart version = App version = Release tag**: All versions are synchronized for simplicity (e.g., chart 0.1.4 = app 0.1.4 = release v0.1.4)
